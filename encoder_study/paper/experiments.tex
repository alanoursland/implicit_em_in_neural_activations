...
The SAE encoder weights lack structure because the encoder is not required to be interpretable. The decoder performs reconstruction; the encoder only needs to produce activations that the decoder can invert. Structure resides in the decoder, not the encoder.
