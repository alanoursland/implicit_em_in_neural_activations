...
The objective contains no explicit sparsity penalty. Sparse representations nevertheless arise. As components specialize, each input activates only a few components. Sparsity emerges from structure.
...
Learned features should resemble prototypes that compete for data. Visualized features should exhibit global structure.
