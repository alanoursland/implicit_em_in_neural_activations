...
Under Gaussian assumptions, log-variance is proportional to differential entropy \citep{linsker1988self}. Maximizing this term encourages each component to carry information rather than remain constant. The logarithmic barrier ensures that collapse is forbidden. As $\text{Var}(A_j) \to 0$, the penalty diverges. This is exactly the diagonal of the log-determinant in the uncorrelated case.
